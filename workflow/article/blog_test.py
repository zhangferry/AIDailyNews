import unittest
from workflow.article.rss import RSS
...
class MyTestCase(unittest.TestCase):
    ...
    def test_blog(self):
        rss = RSS(title="Apple Investigating 'Ghost Touches' Issue Affecting Some Series 9 and Ultra 2 Watches",
